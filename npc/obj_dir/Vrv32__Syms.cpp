    ...
    , TOP{this, namep}
{
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        __Vscope_rv32__register_file_inst.varInsert(__Vfinal,"regs", &(TOP.rv32__DOT__register_file_inst__DOT__regs), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RD,2 ,31,0 ,31,0);
    }
}
