...
VL_INLINE_OPT void Vrv32_register_file___ico_sequent__TOP__rv32__register_file_inst__0(Vrv32_register_file* vlSelf) {
    ...
    // Body
    vlSelf->__PVT__src1 = ((0U == (0x1fU & (vlSymsp->TOP__rv32.inst 
                                            >> 0xfU)))
                            ? 0U : vlSelf->regs[(0x1fU 
                                                 & (vlSymsp->TOP__rv32.inst 
                                                    >> 0xfU))]);
    vlSelf->__PVT__src2 = ((0U == (0x1fU & (vlSymsp->TOP__rv32.inst 
                                            >> 0x14U)))
                            ? 0U : vlSelf->regs[(0x1fU 
                                                 & (vlSymsp->TOP__rv32.inst 
                                                    >> 0x14U))]);
...
VL_INLINE_OPT void Vrv32_register_file___nba_sequent__TOP__rv32__register_file_inst__0(Vrv32_register_file* vlSelf) {
    ...
    if (vlSymsp->TOP.rst) {
        ...
        __Vdlyvval__regs__v32 = (((IData)(vlSymsp->TOP__rv32.__PVT__reg_wen) 
                                  & (0U != (0x1fU & 
                                            (vlSymsp->TOP__rv32.inst 
                                             >> 7U))))
                                  ? vlSymsp->TOP__rv32.__PVT__reg_in
                                  : vlSelf->regs[(0x1fU 
                                                  & (vlSymsp->TOP__rv32.inst 
                                                     >> 7U))]);
        __Vdlyvset__regs__v32 = 1U;
        __Vdlyvdim0__regs__v32 = (0x1fU & (vlSymsp->TOP__rv32.inst 
                                           >> 7U));
    }
