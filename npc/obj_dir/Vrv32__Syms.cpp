    ...
    , TOP__rv32__register_file_inst{this, Verilated::catName(namep, "rv32.register_file_inst")}
{
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        __Vscope_rv32.varInsert(__Vfinal,"inst", &(TOP__rv32.inst), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
        __Vscope_rv32.varInsert(__Vfinal,"pc", &(TOP__rv32.pc), false, VLVT_UINT32,VLVD_NODIR|VLVF_PUB_RW,1 ,31,0);
